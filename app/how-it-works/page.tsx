...
export const metadata: Metadata = {
  title: "How It Works",
  description: "Learn how BoatDetailers.com works — apply, get listed, and connect with boat owners in your city.",
};
...
const steps = [
  ...
  },
  {
    ...
    title: "Get Reviewed",
    description:
      "Our team verifies your business and confirms your application details. Every qualifying business is accepted. If we need anything to finalize your listing, we'll reach out directly.",
  },
  {
    num: "03",
    title: "Go Live",
          ...
          <FadeIn>
            <div className="flex flex-col sm:flex-row items-center gap-4 mb-16">
              ...
              <span className="text-muted text-sm">
                Questions? Call{" "}
                <a href="tel:+18664504873" className="text-teal font-semibold hover:underline">
                  (866) 450-4873
                </a>
              </span>
            </div>
                ...
                <div className="bg-white rounded-xl border border-teal/30 p-6">
                  ...
                  <ul className="space-y-1.5">
                    {[
                      ...
                      "First-come — limited to one per city",
                    ].map((f) => (
                      <li key={f} className="flex items-start gap-2 text-sm text-muted">
                        <span className="text-teal font-bold mt-0.5">✓</span>
                        {f}
