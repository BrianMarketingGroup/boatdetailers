      ...
      <Container>
        <div className="flex h-16 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5">
            <Image src="/sailing-boat.svg" alt="BoatDetailers.com" width={32} height={32} className="h-8 w-8 object-contain" />
            <span className="flex flex-col items-center">
              <span className="font-display text-lg font-bold text-white leading-none">
                BoatDetailers<span className="text-teal">.com</span>
              </span>
              <span className="text-[9px] text-white/50 tracking-widest uppercase mt-0.5">
                Detail &middot; Polish &middot; Shine
              </span>
            </span>
          </Link>
