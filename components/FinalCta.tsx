        ...
        <FadeIn>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-8">
              Featured Listing is limited to one business per city — first-come, first-served.
              Apply now to lock in your spot at the August 2026 launch and get your business in front of boat owners in your market.
            </p>
